...
impl NodeTypeId {
    pub const FLOAT_CONSTANT: &'static str = "core.float_constant";
    pub const COLOR_CONSTANT: &'static str = "core.color_constant";
    pub const DISPLAY: &'static str = "core.display";
    pub const PLOT: &'static str = "core.plot";
    pub const DELAY: &'static str = "core.delay";
    pub const WLED_TARGET: &'static str = "net.wled_target";
    ...
    pub const SCALE_COLOR: &'static str = "color.scale";
    pub const MULTIPLY_COLOR: &'static str = "color.multiply";
    pub const TINT_FRAME: &'static str = "color.tint_frame";
    pub const MASK_FRAME: &'static str = "color.mask_frame";
    pub const MIX_COLOR: &'static str = "color.mix";
    pub const ALPHA_OVER: &'static str = "color.alpha_over";
    pub const FADE: &'static str = "color.fade";
    pub const MOVING_AVERAGE: &'static str = "color.moving_average";
    pub const BOX_BLUR: &'static str = "color.box_blur";
    pub const GAUSSIAN_BLUR: &'static str = "color.gaussian_blur";
    pub const MEDIAN_FILTER: &'static str = "color.median_filter";
    pub const SPECTRUM_ANALYZER: &'static str = "color.spectrum_analyzer";
    pub const SOLID_FRAME: &'static str = "anim.solid_frame";
    pub const RAINBOW_SWEEP: &'static str = "anim.rainbow_sweep";
    pub const CIRCLE_SWEEP: &'static str = "anim.circle_sweep";
    pub const LEVEL_BAR: &'static str = "anim.level_bar";
    pub const TWINKLE_STARS: &'static str = "anim.twinkle_stars";
    pub const PLASMA: &'static str = "anim.plasma";
    pub const BOUNCING_BALLS: &'static str = "anim.bouncing_balls";
    pub const FRAME_BRIGHTNESS: &'static str = "color.frame_brightness";
...
mod tests {
    ...
    fn parameters_are_visible_without_an_explicit_condition() {
        let definition = NodeParameterDefinition {
            name: "custom_value".to_owned(),
