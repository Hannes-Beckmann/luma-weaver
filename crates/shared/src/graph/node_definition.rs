...
impl NodeTypeId {
    ...
    pub const TYPE_DEBUG: &'static str = "debug.type_debug";
    ...
    pub const ADD: &'static str = "math.add";
    pub const SUBTRACT: &'static str = "math.subtract";
    pub const DIVIDE: &'static str = "math.divide";
    pub const ABS: &'static str = "math.abs";
    pub const MIN_MAX: &'static str = "math.min_max";
    pub const CLAMP: &'static str = "math.clamp";
    pub const POWER: &'static str = "math.power";
    pub const ROOT: &'static str = "math.root";
    pub const EXPONENTIAL: &'static str = "math.exponential";
    pub const LOG: &'static str = "math.log";
    pub const MAP_RANGE: &'static str = "math.map_range";
    pub const ROUND: &'static str = "math.round";
    pub const MULTIPLY: &'static str = "math.multiply";
    ...
    pub const EXTRACT_CHANNELS: &'static str = "frame_operations.extract_channels";
