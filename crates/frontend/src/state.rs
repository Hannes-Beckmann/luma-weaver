...
pub(crate) struct GraphState {
    ...
    pub(crate) node_diagnostic_summaries: HashMap<String, NodeDiagnosticSummary>,
    pub(crate) node_diagnostic_details: HashMap<String, Vec<NodeDiagnosticEntry>>,
...
impl Default for GraphState {
    ...
    fn default() -> Self {
        Self {
            ...
            node_diagnostic_summaries: HashMap::new(),
            node_diagnostic_details: HashMap::new(),
...
pub(crate) struct SubscriptionState {
    ...
    pub(crate) diagnostics_graph_subscription: Option<String>,
...
impl Default for SubscriptionState {
    ...
    fn default() -> Self {
        Self {
            ...
            diagnostics_graph_subscription: None,
